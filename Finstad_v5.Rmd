...
ggplot(scaled.df)+geom_col(aes(x=Estimate,y=Parameter, fill = model, group = model),position="dodge")+
  geom_errorbar(aes(y=Parameter,xmin = Estimate-std.error,xmax=Estimate+std.error),position = "dodge")+
  theme_light()
