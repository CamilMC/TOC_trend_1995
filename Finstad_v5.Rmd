...
# ndvi
lm.coef.backtransformed[1,2] <- 10^(lm.coef.rc[1,i]*0.1) # effect size
...
# log.runoff
lm.coef.backtransformed[2,2] <- 1.1^(lm.coef.rc[3,i]) #log-log
lm.coef.backtransformed[2,3] <- 1.1^(lm.coef.rc[3,i])*log(1.1)*lm.coef.rc[3,j]

# log.prec
lm.coef.backtransformed[3,2] <- 1.1^(lm.coef.rc[4,i]) #log-log
lm.coef.backtransformed[3,3] <- 1.1^(lm.coef.rc[4,i])*log(1.1)*lm.coef.rc[4,j]

# temp
lm.coef.backtransformed[4,2] <- 10^(lm.coef.rc[5,i]*0.1) # effect size
lm.coef.backtransformed[4,3] <- 0.1*log(10)*10^(lm.coef.rc[5,i]*0.1)*lm.coef.rc[5,j]

# bogs
lm.coef.backtransformed[5,2] <- 10^(lm.coef.rc[6,i]*0.1) # effect size
lm.coef.backtransformed[5,3] <- 0.1*log(10)*10^(lm.coef.rc[6,i]*0.1)*lm.coef.rc[6,j]

# arable
lm.coef.backtransformed[6,2] <- 10^(lm.coef.rc[7,i]*0.1) # effect size
lm.coef.backtransformed[6,3] <- 0.1*log(10)*10^(lm.coef.rc[7,i]*0.1)*lm.coef.rc[7,j]

# tndep
lm.coef.backtransformed[7,2] <- 10^(lm.coef.rc[8,i]*0.1) # effect size
lm.coef.backtransformed[7,3] <- 0.1*log(10)*10^(lm.coef.rc[8,i]*0.1)*lm.coef.rc[8,j]



coef.plot.backtransformed <- ggplot(lm.coef.backtransformed)+geom_col(aes(x=exp.var,y=Estimate,fill=Estimate))+theme_light()+scale_fill_gradient2(low="#4575B4",mid="#FFFFBF",high = "#D73027",midpoint = 0)
