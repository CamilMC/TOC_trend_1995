...
ssp585.cnrm.prec <- raster::raster("worldclim_future/wc2.1_2.5m_bioc_CNRM-CM6-1_ssp585_2041-2060.tif", band = 12)
...
ssp585.temp.wr <- raster::extract(ssp585.cnrm.temp,select(wr.sf.3,c("gid","geometry")),fun=mean,df = T, sp = T)
saveRDS(ssp585.temp.wr,"ssp585.temp.wr.rds")
