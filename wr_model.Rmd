...
names(ssp126.runoff.2100) <- c("gid","runoff126.2100")
...
names(ssp370.runoff.2100) <- c("gid","runoff370.2100")
...
noforest <- filter(wr.sf.forest,forest0 == 0)
...
weird.cat <- wr.sf.forest %>% filter(gid == weird.gid) %>% st_transform(CRS("EPSG:3035"))
