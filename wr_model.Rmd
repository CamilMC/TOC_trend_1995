...
map.ndvi <- ggplot()+geom_sf(data = result, aes(fill = effect.ndvi, col = effect.ndvi))+scale_fill_distiller(type = "seq", palette = 8, aesthetics = c("colour","fill"), direction = 1)+theme_minimal()
ggsave(plot = map.ndvi, filename = "effect.ndvi.png",dpi = "retina", width = 30, height = 90, units = "cm")

map.runoff <- ggplot()+geom_sf(data = result, aes(fill = effect.runoff, col = effect.runoff))+scale_fill_distiller(type = "seq", palette = 8, aesthetics = c("colour","fill"), direction = 1)+theme_minimal()
ggsave(plot = map.runoff, filename = "effect.runoff.png",dpi = "retina", width = 30, height = 90, units = "cm")

map.bogs <- ggplot()+geom_sf(data = result, aes(fill = effect.bogs, col = effect.bogs))+scale_fill_distiller(type = "seq", palette = 8, aesthetics = c("colour","fill"), direction = 1)+theme_minimal()
