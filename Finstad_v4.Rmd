...
# SEM model with bogs, temp and precipitation
...
#slope.df <- data.frame(ebint = remote.set$ebint, slope = slope.fennoscandia )
saveRDS(slope.fennoscandia, "slope.fennoscandia.Rdata")
```
### Corine Land Cover
