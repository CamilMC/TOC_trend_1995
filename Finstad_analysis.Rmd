...
2. The land-use data was extracted from the Corine land-cover database (http://www.eea.europa.eu/publications/COR0-landcover). The land cover classes were merged the following way:
  + woodland = agro_forestry_are + broad_leave_area + coniferous_forest_area + mixed forest aread
...
for (i in names(waterchem_1995)[-which(names(waterchem_1995) %in% c("date_mmdd", "Longitude","Latitude", "lake_name"))]){
