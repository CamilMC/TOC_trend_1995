...
v <- c("toc_mg_l","runoff","temp","prec","bogs","arable","forest","tndep","tsdep")
names(fennoscandia)[which(names(fennoscandia) %in% v)] <- c("TOC", "Runoff","Temp","Precip","Bog","Forest","Arable","TNdep","TSdep")
