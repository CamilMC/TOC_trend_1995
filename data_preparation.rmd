...
fennoscandia <- fennoscandia %>% filter(is.na(layer) == F)
...
fennoscandia$log.prec <- log10(fennoscandia$bio12+0.0001) %>% scale()
fennoscandia$log.slope <- log10(fennoscandia$layer+0.0001) %>% scale()
