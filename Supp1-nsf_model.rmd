...
THe mean of the 30 years between 1970 and 2000 is used (p11 on EURO-CORDEX guidelines https://www.euro-cordex.net/imperia/md/content/csc/cordex/guidance_for_euro-cordex_climate_projections_data_use__2021-02_1_.pdf).
...
`r `tab_nums("summary-lm-5","Results for the linear model with 5 selected predictors on Norway, Sweden and Finland")`
...
`r `fig_nums("residuals-lm-5","Residuals for linear model, a) with scaled variables, b) with unscaled variables")`
...
The residuals for scaled and unscaled models are presented in `r fig_num("sem-residuals",display = "c")`
...
`r fig_num("sem-residuals","Map of residuals for a) scaled and b) unscaled SELM")`
...
`r fig_num("compare-plot-5","Comparison of scaled estimates for LM and SELM (left) and of the effect sizes for each predictor (right) with NDVI, logRunoff, Bog, Arable and TNdep as predictors")`
...
`r tab_num("table-lm-9","Summary table for linear model with 9 predictors")`
...
`r fig_num("lm-residuals-9","Map of residuals for a) scaled and b) unscaled LM with 9 predictors")`
...
`r tab_num("table-sem-9","Summary table for spatial error linear model with 9 predictors")`
...
```{r residuals-sem-9}
s.sem.fen.9 <- readRDS("s.sem.fen.9.rds")
sem.fen.9 <- readRDS("sem.fen.9.rds")
...
`r fig_num("residuals-sem-9","Map of residuals for a) scaled and b) unscaled SELM with 9 predictors")`
...
`r fig_num("compare-plot-9","Comparison of scaled estimates for LM and SELM (left) and of the effect sizes for each predictor (right) with 9 predictors")`
...
`r tab_num("table-sem-3","Summary table for SELM model with 3 predictors")`
...
`r fig_num("sem-residuals-3","Map of residuals for a) scaled and b) unscaled SELM with 3 predictors")`
...
`r fig_nums(name = "compare-plots-3", caption = "Comparison of scaled estimates for LM and SELM (left) and of the effect sizes for each predictor (right) with 9 predictors")`
...
`r fig_nums(name = "residuals-precip", caption = "Map of residuals for SELM model with NDVI, log Precipitation and Bog as predictors, on a) scaled and b) unscaled variables")`
...
`r tab_num("table-sem-precip","Summary table for SELM model with 3 predictors: NDVI, TNdep and logPrecip")`
...
`r fig_nums(name = "residuals-precip", caption = "Map of residuals for SELM model with NDVI, TNdep and log Precipitation as predictors, on a) scaled and b) unscaled variables")`
...
`r fig_nums(name = "compare-plots-tndep", caption = "Comparison of scaled estimates and effect sizes from the SELM model with NDVI, TNdep and log Precipitation as predictors.")`
