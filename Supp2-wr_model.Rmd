...
```{r print-plot-forecast-precip, fig.dim = c(12,8)}
...
```{r print-plot-forecast-ndvi, fig.dim = c(12,8)}
...
```{r print-plot-forecast-runoff, fig.dim = c(12,8)}
...
```{r print-plot-forecast-tndep, fig.dim = c(12,8)}
...
ggsave(filename = "WR/TOC_export_abs.png", dpi = "retina", width = 6, height = 5, units = "cm")
